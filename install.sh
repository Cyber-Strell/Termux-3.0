...
echo "  zsh
                ...
                echo "......................................!" | pv -qL 100
                echo "This_Is_Gokul" | pv -qL 15
                exit
                echo "This_Is_Gokul" | pv -qL 500  " >> .bashrc
## echoing .zshrc file
echo "
sleep 3
neofetch | pv -qL 500
sleep 4
clear
toilet -f smblock --filter border:metal 'GOKUL.TERMUX'
PROMPT=$'%F{%(#.blue.green)}👽[Strell]-[%B%F{reset}%b%F{%(#.blue.green)}㉿]\n└─%B%(#.%F{red}#.%F{blue}$)%b%F{reset} '
